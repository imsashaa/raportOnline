    ...
    <nav class="navbar navbar-default navbar-fixed-top">
      <div class="brand">
        <a href="/"><img src="{{asset('admin/assets/img/logo-yii.png')}}" style="width: 95px; height: 25px;" alt="Klorofil Logo" class="img-responsive logo"></a>
      </div>
      <div class="container-fluid">
        ...
        <form class="navbar-form navbar-left">
          <div class="input-group">
            ...
            <span class="input-group-btn"><button type="button" class="btn btn-primary">Pergi</button></span>
          </div>
        </form>
        <div id="navbar-menu">
